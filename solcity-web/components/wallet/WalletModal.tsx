        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-border">
              <h2 className="text-xl font-semibold">Connect a wallet on Solana to continue</h2>
              <button
                type="button"
                onClick={onClose}
            ...
            <div className="p-6 max-h-[60vh] overflow-y-auto">
                    ...
                    return (
                      <motion.button
                        ...
                        animate={{
                          ...
                          backgroundColor: isSelected ? "rgba(208, 255, 20, 0.1)" : "rgba(17, 17, 17, 1)"
                        }}
                        exit={{ opacity: 0, y: -20 }}
                        transition={{ duration: 0.2 }}
                        ...
                        className={`flex items-center gap-4 p-4 bg-panel border rounded-lg transition-all disabled:cursor-not-allowed group relative overflow-hidden ${isSelected
                      ...
                      >
                        ...
                        />
                        <span className={`flex-1 text-left font-medium transition-colors relative z-10 ${isSelected ? "text-accent" : "text-text-primary group-hover:text-accent"
                          }`}>
                          {wallet.adapter.name}
                        </span>
              ...
              {/* More Options Button */}
              {!expanded && (installedWallets.length > 3 || notInstalledWallets.length > 0) && (
                <motion.button
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
