 ...
 *
 * Navigation bar for customer-facing pages with wallet connection and route highlighting.
 * Provides navigation to customer dashboard sections with active state indicators.
 *
 * Features:
 * - Solcity branding with logo
 * - Customer navigation links (Dashboard, Explore, History, Redeem, Profile)
