 ...
 * Navbar Component
 *
 * Main navigation bar for the application with wallet connection and business dropdown.
 * Provides navigation to all major sections with active state indicators.
 *
 * Features:
 * - Solcity branding with logo
 * - Navigation links (Explore, Dashboard)
 * - Animated "For Businesses" dropdown menu with merchant links
 * - Wallet connection button with dropdown menu
 * - Connected wallet display with formatted address
 * - Wallet actions: Copy address, View profile, Disconnect
