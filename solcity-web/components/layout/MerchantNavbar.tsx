      ...
      <nav className="h-[72px] border-b border-border bg-background/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="h-full max-w-[1400px] mx-auto px-8 flex items-center justify-between">
          <Link href="/" className="text-lg font-bold tracking-wider flex gap-3 items-center">
            ...
            SOLCITY
            <span className="text-xs font-normal text-text-secondary">for Merchants</span>
          </Link>

          <div className="flex gap-10 items-center">
            <Link
              href="/merchant"
              className={`text-sm font-medium transition-colors ${isActive("/merchant") && pathname === "/merchant" ? "text-accent" : "text-text-secondary hover:text-accent"
                }`}
            >
              Dashboard
            </Link>
            <Link
              ...
              className={`text-sm font-medium transition-colors ${isActive("/merchant/register") ? "text-accent" : "text-text-secondary hover:text-accent"
                }`}
            >
              Register
            </Link>
            <Link
              href="/merchant/rules"
              className={`text-sm font-medium transition-colors ${isActive("/merchant/rules") ? "text-accent" : "text-text-secondary hover:text-accent"
                }`}
            >
              Rules
            </Link>
