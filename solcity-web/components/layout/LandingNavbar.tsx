 ...
 *
 * Navigation bar for the landing page with wallet connection functionality.
 * Provides navigation to main sections and wallet management dropdown.
 *
 * Features:
 * - Solcity branding with logo
 * - Navigation links (Explore, For Customers, For Merchants)
