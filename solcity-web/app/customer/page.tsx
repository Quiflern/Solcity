 ...
 *
 * Main dashboard for customers showing:
 * - Loyalty tier status and progress
 * - Total rewards earned
 * - Transaction history
 * - Projected earnings chart
 * - QR code for merchant scanning
 *
 * @returns Customer dashboard component with stats and transaction history
 */
export default function CustomerDashboard() {
  ...
  /**
   * Copies the customer's wallet address to clipboard
   */
